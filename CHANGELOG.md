...
- **vLLM visibility**: vLLM now appears in the provider list, clearly marked unavailable on Apple Silicon (it is CUDA-only), with a pointer to run it remotely through a Local/Custom Endpoint, instead of being silently hidden.
